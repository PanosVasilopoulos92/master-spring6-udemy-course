...
import org.viators.practice_project16.eazyschool.service.ContactService;
...
public class ContactController {
    ...
    public ModelAndView displayMessages(Model model, @PathVariable(name = "pageNum") int pageNum,
        ...
        Page<Contact> msgPage = contactService.findMsgsWithOpenStatusPageable(pageNum, sortField, sortDir);
